# -*- coding: utf-8 -*-
"""
Created on Mon Mar 10 13:49:58 2014
...
class SnakeWorld:
    def __init__(self):
        ...
        for x in range(10,630,10): #This loop adds all the blocks which make up the game board
              for y in range(10,470,10):
                  block = Block((10+y/2,255-(y/2),255-y/5),10,10,x,y) #Creates one instance of the Block object
    ...
    def update(self):
        ...
        if self.headRect.colliderect(self.head2Rect):
            self.msgObject = self.font.render('GAME OVER',False,(127,255,0))
            self.msgObject2 = self.font2.render('P1 Score was: '+str(self.score),False,(255,0,255))
            self.msgObject25 = self.font2.render('P2 Score was: ' + str(self.score2),False,(255,0,255))
            if self.score>self.score2:
                self.msgObject255 = self.font2.render('P1 Wins',False,(255,0,255))
            elif self.score==self.score2:
                self.msgObject255 = self.font2.render('It is a Tie',False,(255,0,255))
            elif self.score<self.score2:
                self.msgObject255 = self.font2.render('P2 Wins',False,(255,0,255))
        ...
        for tail in self.tails:
            ...
            if self.head2Rect.colliderect(tailrect):
                ...
                tail=Tail((0,0,200),10,10,self.head2.x,self.head2.y)
                self.tails2.append(tail)
            else:
                pass
...
class PyGameWindowView:
    def __init__(self,model,screen):
        ...
        self.screen = screen
    def draw(self):
        self.screen.fill(pygame.Color(255, 	153, 	18))
